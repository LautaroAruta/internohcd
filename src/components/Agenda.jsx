    ...
    <div className="hardware-unit animate-fade-in" style={{ padding: '36px', display: 'flex', flexDirection: 'column', gap: '28px', height: '100%', overflowY: 'auto' }}>
      ...
      <div style={{ background: 'var(--bg-card)', border: '2px solid var(--border-dark)', borderRadius: '16px', padding: '24px', boxShadow: '4px 4px 0px var(--border-dark)', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div className="calendar-grid-container" style={{ overflowX: 'auto', paddingBottom: '12px' }}>
          <div className="calendar-7col-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(7, minmax(0, 1fr))', gap: '8px', width: '100%', textAlign: 'center', fontFamily: 'var(--font-mono)', fontSize: '0.85rem', fontWeight: '800', color: 'var(--text-muted)' }}>
            <div>DOM</div>
            <div>LUN</div>
            <div>MAR</div>
            <div>MIE</div>
